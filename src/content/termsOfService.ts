 ...
 * `terms-of-service`, revision 2, pulled 2026-08-18. This is the single file
 ...
 * THEA-12a). Revision 2 added a Section 2 (Eligibility, 18+ for accounts)
 * scoped explicitly to accounts — it does not narrow the app's separate
 * under-18/21/25 in-app safety notices (AGENTS.md invariant 7); it renumbers
 * everything after it.
 *
...
export const TERMS_OF_SERVICE_BODY: Array<{ heading: string; body: string }> = [
  ...
  {
    heading: '5. User Responsibility and Assumption of Risk',
  ...
  {
    heading: '7. Legal and Regulatory Compliance',
